...
[![CI Status](https://github.com/igor-kan/aistylist/workflows/CI/badge.svg)](https://github.com/igor-kan/aistylist/actions)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Last Commit](https://img.shields.io/github/last-commit/igor-kan/aistylist)](https://github.com/igor-kan/aistylist/commits/main)
...
```bash
docker build -t aistylist .
docker run -p 3000:3000 aistylist
```
...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/aistylist.git`
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/igor-kan/aistylist/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/igor-kan/aistylist/discussions)

## 🔗 Links

- 🌐 **Live Demo**: https://igor-kan.github.io/aistylist
- 📚 **Documentation**: [Full Documentation](docs/)
- 🎯 **Project Board**: [GitHub Projects](https://github.com/igor-kan/aistylist/projects)
