# Contributing to aistylist

Thank you for your interest in contributing to aistylist! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/aistylist.git
   cd aistylist
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/aistylist.git
   ```
...
By contributing to aistylist, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
